...
class SnakeGame:
    ...
    def _get_state(self) -> np.ndarray:
        ...
        # Geodesic distances for next positions
        ...
        # Find the minimum distance among the 3 choices
        min_d = min(d_s, d_l, d_r)
        
        # If all are unreachable or equal, we default to False
        ...
        return np.array([
            ...
            dy_food == -1,                  # food UP
            dy_food == 1,                   # food DOWN
            geo_s,                          # geodesic straight is best
            geo_l,                          # geodesic left is best
            geo_r                           # geodesic right is best
        ], dtype=np.float32)
